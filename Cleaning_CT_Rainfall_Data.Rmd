...
This is done by creating a 'Year' column using mutate() and then group_by(). And then using the summary function to get the total rainfall that fell every year.
...
From there is it possible to calulate the 10 year average precipitation using ungroup(), mutate() and mean(), and then caluclating each year's percentage difference from that mean.
